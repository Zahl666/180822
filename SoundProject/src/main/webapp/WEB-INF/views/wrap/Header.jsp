...
<body>
	...
	<ul>
		...
		<li><input type="image"
			src="<c:url value="/resources/img/Text_Button2.png" />" id=search
			width="250"
			style="border: 0; background-color: white; margin-left: -85px; position: absolute; inline-size: 21px; line-height: 15px; margin-top: 8px; outline: none;" /></li>
		<li id="ajax3"><button
		...
		<li id="ajax"><button
				style="text-decoration: none; background-color: black; color: white; border: 0; outline: none; cursor:pointer;">Sign
				in</button></li>
		<li id="ajax2"><button
				style="text-decoration: none; background-color: black; color: white; border: 0; outline: none; cursor:pointer;">Create Account
				</button></li>
	</ul>
	</nav>
	<!-- 레이어 팝업 -->
